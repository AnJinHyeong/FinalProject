		...
		<div class="section-project-row" style="padding: 25px 0 200px 0;">
			...
			<div style="width: 100%; display: flex; -webkit-box-pack: justify; justify-content: space-between; padding: 20px 0;">
				<a class="project-main-link" href="${root}/project/${projectNo}/projectMainDefault">
					...
					<p>
						<strong>기본정보</strong> <span class="project-main-span">71% 작성완료</span>
					</p>
					...
					<p>
						<strong>펀딩 계획</strong> <span class="project-main-span">0% 작성완료</span>
					</p>
					...
					<p>
						<strong>선물 구성</strong> <span class="project-main-span">0% 작성완료</span>
					</p>
					...
					<p>
						<strong>스토리</strong> <span class="project-main-span">10% 작성완료</span>
					</p>
					...
					<p>
						<strong>창작자 정보</strong> <span class="project-main-span">10% 작성완료</span>
					</p>
				</a>
			</div>
