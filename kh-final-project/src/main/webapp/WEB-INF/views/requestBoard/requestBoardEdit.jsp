...
<script>
	$(function(){
		...
		var requestEditCategoryNo = ${requestEdit.requestCategoryNo};
		
		$("#parentsCategory").val(requestEditCategoryNo);
				...
				<c:when test="${not empty memberNo}">
					<div class="container-1200 h700 mt30 mb30" style="border: 1px solid #dcdcdc; border-radius: 8px;">
						<div style="height: 100%; width: 100%;">
							<p style="padding-left: 20px; font-size: 25px; font-weight: bold; width: 1100px; margin: 20px auto; border-bottom: 1px solid red; padding-bottom: 5px;">게시글 수정</p>
						
							<form action="requestEdit" method="post">
								<input type="hidden" value="${requestEdit.requestNo}" name="requestNo">
								<div class="request-insert-div">
									...
									<div class="request-insert-div2">
										<div>
											<input type="text" required autocomplete="off" name="requestTitle" max="100" value="${requestEdit.requestTitle}" style="width: 620px; height: 40px; border: 1px solid rgb(240, 240, 240);">
										</div>
									</div>
								</div>
								...
								<div class="request-insert-div" style="margin-bottom: 100px;">
									...
									<div class="request-insert-div2">
										<div>
											...
											<textarea class="project-insert-text" maxlength="1000" rows="1" name="requestContent" required autocomplete="off" style="height: 150px;">${requestEdit.requestContent}</textarea>
										</div>
									</div>
								</div>
								
								<div class="project-insert-div3" style="width: 1100px; margin: 0 0 0 40px; padding-top: 20px;">
									<input class="request-btn" type="submit" value="수정">
								</div>
							</form>					
						</div>
					</div>
