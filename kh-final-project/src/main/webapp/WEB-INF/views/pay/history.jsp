...
ul li a:hover, ul li a:focus {
    ...
    <div id =tableAll>
<h2 id = historyTitle>결제 조회 내역</h2><br>
<table class = type09>
<tr>
<th>결제번호</th>
<th>결제코드</th>
...
<tr>
		...
		<td> <fmt:formatDate value="${payDto.payDate}" pattern="yyyy-MM-dd [E] a hh:mm:ss"/></td>
	</tr>
</c:forEach>
	</table>
...
<div>
  <ul>
    ...
    <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
    	<li><a href="history${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
    </c:if> 
  </ul>
</div>
<br>
